...
# -*- coding: utf-8 -*-
"""
Created on Mon Jan 18 02:35:21 2021

@author: Neeraj Tandel
"""
...
sourceData = "311_service_requests.csv"
...
def MakeLog(startLine, numLines):
    destData = time.strftime("/var/log/311_service_requests/%Y%m%d-%H%M%S.log")
